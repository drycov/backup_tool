...
from .device_probe import fetch_device_hostname
from .models import CredentialProfile, Device, ScanResult, ScanStatus, ScanSummary, PortResult
...
async def apply_device_names(
    ...
    for device in devices:
        ...
        from .inventory import rename_device
