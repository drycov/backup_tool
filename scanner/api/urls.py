...
urlpatterns = [
    ...
    path("api/settings/radius", views.radius_settings_dispatch, name="settings-radius"),
    path("api/settings/radius/test", views.radius_settings_test_view, name="settings-radius-test"),
    ...
    path("api/settings/env", views.env_settings_view, name="settings-env"),
    path("api/settings/env/export", views.env_settings_export_view, name="settings-env-export"),
    ...
    path(
        "api/provisioning/analysis/runs/<str:run_id>",
        views.provision_analysis_run_detail_view,
        name="provision-analysis-run-detail",
    ),
    path("api/provisioning/templates/<int:template_id>", views.provision_template_detail, name="provision-template-detail"),
    path("api/provisioning/preview", views.provision_preview_view, name="provision-preview"),
    path("api/provisioning/run", views.provision_run_view, name="provision-run"),
    path("api/provisioning/runs", views.provision_runs_view, name="provision-runs"),
    path("api/provisioning/bulk", views.provision_bulk_dispatch, name="provision-bulk"),
    path("api/provisioning/bulk/run", views.provision_bulk_run_view, name="provision-bulk-run"),
    path("api/provisioning/bulk/<int:bulk_run_id>", views.provision_bulk_detail_view, name="provision-bulk-detail"),
